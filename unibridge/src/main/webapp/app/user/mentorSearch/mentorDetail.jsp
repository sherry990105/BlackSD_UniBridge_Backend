...
<body>
    ...
    <main id="mentorMainContainer">
        <div id="mentorDetail">
            ...
            <div id="detailHead">
                <img src="${pageContext.request.contextPath}/assets/img/user/userProfile/ex1.png" alt="프로필 사진" id="profileImg">
                <div id="mentoExplan">
                    <div class="mentoSpec">
                    ...
                    <div id="paymentfoot">
                        <c:choose>
                            <c:when test="${isMatching}">
                                ...
                                <button type="button" class="btn-disabled" disabled>결제 불가 (매칭 진행 중)</button>
                            </c:when>
                            <c:otherwise>
                                <div id="price">
                                    <div>결제금액</div>
