...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin/adminBoard/mentorBoard/boardList.css" />
</head>
<body>
...
<script>
  ...
  <script src="${pageContext.request.contextPath}/assets/js/admin/adminBoard/mentorBoard/boardList.js"></script>
</body>
</html>