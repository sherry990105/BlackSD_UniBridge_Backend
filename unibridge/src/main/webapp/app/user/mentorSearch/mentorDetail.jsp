...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/user/mentorSearch/mentorDetail.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/header.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/footer.css">
    
    <script defer src="${pageContext.request.contextPath}/assets/js/user/mentorSearch/mentorDetail.js"></script>
    <script defer src="${pageContext.request.contextPath}/assets/js/header.js"></script>
</head>
<body>
    <%-- 1. 헤더 포함 (임시 세션 주입된 상태) --%>
    <jsp:include page="/app/user/header.jsp" />

    <main style="display: flex; justify-content: center; gap: 40px; padding: 50px;">
        <div id="mentorDetail">
            <div id="detailHead">
                <img src="${pageContext.request.contextPath}/assets/img/user/userProfile/ex1.png" alt="사진" id="profileImg">
                <div id="mentoExplan">
                    <div class="mentoSpec">
            ...
            <div id="detailfoot">
                ...
                <div id="mentoringCurriculum">
                    ...
                    <p>${mentor.gradSchool}에서 전공한 지식을 바탕으로 성심껏 도와드리겠습니다.</p>
                </div>
            </div>
        </div>

        <%-- 2. 결제 영역 (멘티일 때만 활성화) --%>
        <div id="payment" style="width: 300px; border: 1px solid #ddd; padding: 20px; border-radius: 10px; height: fit-content;">
            <c:choose>
                ...
                <c:when test="${sessionScope.memberType eq 'MENTEE'}">
                    <div id="paymenthead">
                        ...
                        <div id="paymentTitle" style="font-size: 18px; margin: 10px 0;">멘토링 1회권</div>
                        <hr>
                    ...
                    <div id="paymentfoot" style="margin-top: 20px;">
                        <div id="price" style="display: flex; justify-content: space-between; margin-bottom: 15px;">
                            <div>결제금액</div>
                ...
                <c:otherwise>
                    <div style="text-align: center; color: #666;">
                        <p>로그인 후<br>멘토링을 신청할 수 있습니다.</p>
                        <button type="button" onclick="location.href='${pageContext.request.contextPath}/signin.mem'" 
