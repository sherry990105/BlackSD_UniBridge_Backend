...
<body>
    ...
    <div class="detail-inner">
      ...
      <div class="profile-col">
        <div class="profile-avatar">
          <div class="profile-avatar">
            <img src="/frontend/assets/img/admin/유저 아이콘.png" alt="유저 아이콘" style="width:90px;height:90px;object-fit:contain;" />
          </div>
        </div>
  ...
  <script src="/frontend/assets/js/admin/adminUserManagement/userDetail/userDetailWaiting.js"></script>
</body>
</html>
